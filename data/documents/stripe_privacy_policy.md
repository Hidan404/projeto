...
-   [Legal](https://stripe.com/en-br/legal)
-   ## Stripe Privacy Policy & Privacy Center
    
    -   [Privacy Policy](https://stripe.com/en-br/privacy)
    -   [Stripe Privacy Center](https://stripe.com/en-br/privacy-center/legal)
    -   [Data Processing Agreement](https://stripe.com/en-br/legal/dpa)
    -   [Data Transfer Addendum](https://stripe.com/en-br/legal/dta)
    -   [Supplier Data Processing Agreement](https://stripe.com/en-br/legal/supplierdpa)
    -   [Supplier Data Transfers Addendum](https://stripe.com/en-br/legal/supplierdta)
    -   [Data Privacy Framework](/en-br/legal/data-privacy-framework)
    -   [Sub-Processors List](https://stripe.com/en-br/service-providers/legal)
    -   [Cookies Policy](https://stripe.com/en-br/cookies-policy/legal)
    

# Privacy Policy

For your convenience, we offer a translation of this page. The translation is for informational purposes only, so the English version of this page is the definitive version.
...
[1\. Personal Data that we collect and how we use and share it](https://stripe.com/en-br/privacy#1-personal-data-we-collect-and-how-we-use-and-share-it)

[2\. More ways we collect, use and share Personal Data](https://stripe.com/en-br/privacy#2-more-ways-we-collect-use-and-share-personal-data)

[3\. Legal bases for processing data](https://stripe.com/en-br/privacy#3-legal-bases-for-processing-personal-data)

[4\. Your rights and choices](https://stripe.com/en-br/privacy#4-your-rights-and-choices)

[5\. Security and retention](https://stripe.com/en-br/privacy#5-security-and-retention)

[6\. International data transfers](https://stripe.com/en-br/privacy#6-international-data-transfers)

[7\. Updates and notifications](https://stripe.com/en-br/privacy#7-updates-and-notifications)

[8\. Jurisdiction-specific provisions](https://stripe.com/en-br/privacy#8-jurisdiction-specific-provisions)

[9\. Contact us](https://stripe.com/en-br/privacy#9-contact-us)

[10\. US Consumer Privacy Notice](https://stripe.com/en-br/privacy#10-us-consumer-privacy-notice)
...
We provide more comprehensive information about our collection, use, and sharing of End Customer Personal Data in our [Privacy Center](https://stripe.com/en-br/legal/privacy-center), including the [legal bases](https://stripe.com/en-br/legal/privacy-center#end-customers) we rely on for processing your Personal Data.

#### a. Personal Data we collect about End Customers

**Transaction Data**. If you're an End Customer making payments to, receiving refunds or payments from, initiating a purchase or donation, or otherwise transacting with our Business User, whether in-person or online, we receive your Transaction Data. We may also receive your transaction history with the Business User. [Learn More](https://stripe.com/en-br/legal/privacy-center#end-customers). Additionally, we may collect information entered into a checkout form even if you opt not to complete the form or transaction with the Business User. [Learn More](https://stripe.com/en-br/legal/privacy-center#promotional-emails-feature). A Business User who uses Stripe’s Terminal Service to provide its goods or services to End Customers may use the Terminal Service to collect End Customer Personal Data (like your name, email, phone number, address, signature, or age) in accordance with its own privacy policy.

**Identity/Verification Information**. Stripe provides a verification and fraud prevention Service that our Business Users can use to verify Personal Data about you, such as your authorization to use a particular payment method. During the process, you’d be asked to share with us certain Personal Data (like your government ID and selfie for biometric verification, Personal Data you input, or Personal Data that is apparent from the physical payment method like a credit card image). To protect against fraud and determine if somebody is trying to impersonate you, we may cross-verify this data with information about you that we've collected from Business Users, Financial Partners, business affiliates, identity verification services, publicly available sources, and other third party service providers and sources. [Learn More](https://stripe.com/en-br/legal/privacy-center#stripe-identity).

**More**. For further information about other types of Personal Data that we may collect about End Customers, including about your online activity, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/en-br/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**Payment processing and accounting**. We use your Transaction Data to deliver Payment-related Business Services to Business Users — including online payment transactions processing, sales tax calculation, and invoice, bill, and dispute handling — and to help them determine their revenue, settle their bills, and execute accounting tasks. [Learn More](https://stripe.com/en-br/legal/privacy-center#end-customers). We may also use your Personal Data to provide and improve our Business Services.

During payment transactions, your Personal Data is shared with various entities in connection with your transaction. As a service provider or data processor, we share Personal Data to enable transactions as directed by Business Users. For instance, when you choose a payment method for your transaction, we may share your Transaction Data with your bank or other payment method provider, including as necessary to authenticate you, [Learn More](https://stripe.com/en-br/legal/privacy-center#:~:text=How%20does%20Stripe%20use%20and%20share%20data%20to%20authenticate%20my%20transactions%3F), process your transaction, prevent fraud, and handle disputes. The Business User you choose to do business with also receives Transaction Data and might share the data with others. Please review your merchant’s, bank’s, and payment method provider’s privacy policies for more information about how they use and share your Personal Data.
...
-   Payment method providers, like Visa or WeChat Pay, require information about Business Users and their Representatives who accept their payment methods. This information is typically required during the onboarding process or for processing transactions and handling disputes for these Business Users. [Learn More](https://stripe.com/en-br/legal/privacy-center#in-addition-to-its-sub-processors-what-other-third-parties-does-stripe-share-information-with).
...
**Fraud detection and loss prevention**. We use Representatives’ Personal Data to identify and manage risks that our Business Services might be used for fraudulent activities causing losses to Stripe, End Users, End Customers, Business Users, Financial Partners, and others. We also use information about you obtained from publicly available sources, third parties like credit bureaus and from our Services to address such risks, including to identify patterns of misuse and monitor for terms of service violations. Stripe may share Representatives' Personal Data with Business Users, our Financial Partners, and third party service providers, including phone verification providers, [Learn More](https://stripe.com/en-br/legal/privacy-center#how-does-stripe-collect-information-for-phone-verification), to verify the information provided by you and identify risk indicators. [Learn More](https://stripe.com/en-br/legal/privacy-center#from-where-does-stripe-collect-information-used-for-fraud-prevention-and-security-purposes). We also use and share Representatives' Personal Data to conduct due diligence, including conducting anti-money laundering and sanctions screening in accordance with applicable law.

**Advertising**. Where permitted by applicable law, and where required with your consent, we use and share Representatives’ Personal Data with third parties, including [Partners](https://stripe.partners/?f_help-me-with=software-solutions-and-integrations), so we can advertise and market our Services and Partner integrations. Subject to applicable law, including any consent requirements, we may advertise through interest-based advertising and track the efficacy of such ads. See our [Cookie Policy](https://stripe.com/en-br/legal/cookies-policy). We do not transfer your Personal Data to third parties in exchange for payment. However, we may provide your data to third party partners, like advertising partners, analytics providers, and social networks, who assist us in advertising our Services. [Learn more](https://stripe.com/en-br/legal/privacy-center#what-data-may-be-shared-or-made-available-to-enable-me-to-see-stripe-ads-on-other-sites). We may also use your Personal Data, including your Stripe account activity, to evaluate your eligibility for and offer you Business Services or promote existing Business Services. [Learn more](https://stripe.com/en-br/legal/privacy-center#how-do-i-exercise-my-data-protection-rights:~:text=will%20be%20deleted.-,Stripe%20Capital,-Stripe%20Capital%C2%A0provides).

**More**. For further information about additional ways by which we may use and share Representatives’ Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/en-br/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.

### 1.4 Visitors

We collect, use, and share the Personal Data of Visitors. More details about how we collect, use, and share Visitors’ Personal Data, along with the [legal bases](https://stripe.com/en-br/legal/privacy-center#visitors) we rely on for processing such Personal Data, can be found in our [Privacy Center](https://stripe.com/en-br/legal/privacy-center).

#### a. Personal Data we collect about Visitors

When you browse our Sites, we receive your Personal Data, either provided directly by you or collected through our use of cookies and similar technologies. See our [Cookie Policy](https://stripe.com/en-br/legal/cookies-policy) for more information. If you opt to complete a form on the Site or third party websites where our advertisements are displayed (like LinkedIn or Facebook), we collect the information you included in the form. This may include your contact information and other information pertaining to your questions about our Services. We may also associate a location with your visit. [Learn More](https://stripe.com/en-br/legal/privacy-center#does-stripe-collect-precise-location-data).

**More**. Further details about other types of Personal Data that we may collect from Visitors, including your online activity, can be found in the [*More ways we collect, use, and share Personal Data*](https://stripe.com/en-br/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
**More**. For more information about additional ways we may use and share Visitors’ Personal Data, please see the [*More ways we collect, use, and share Personal Data*](https://stripe.com/en-br/privacy#2-more-ways-we-collect-use-and-share-personal-data) section below.
...
-   Training artificial intelligence models to power our Services and protect against fraud and other harm. [Learn more](https://stripe.com/en-br/legal/privacy-center#how-does-stripe-use-personal-data-to-train-artificial-intelligence-models).
...
For purposes of the General Data Protection Regulation (GDPR) and other applicable data protection laws, we rely on a number of legal bases to process your Personal Data. [Learn More](https://stripe.com/en-br/legal/privacy-center#stripe-legal-bases-tables). For some jurisdictions, there may be additional legal bases, which are outlined in the [Jurisdiction-Specific Provisions](https://stripe.com/en-br/privacy#8-jurisdiction-specific-provisions) section below.
...
-   Determination of eligibility for and offering new Stripe Services ([Learn More](https://stripe.com/en-br/legal/privacy-center#stripe-capital));
...
-   Sharing of Personal Data with third party service providers that offer services on our behalf and business partners that help us in operating and improving our business ([Learn More)](https://stripe.com/en-br/service-providers/legal);
...
If you wish to stop receiving marketing-related emails from us, you can opt-out by clicking the unsubscribe link included in such emails or as described [here](https://stripe.com/en-br/legal/privacy-center#how-do-i-exercise-my-data-protection-rights). We'll try to process your request(s) as quickly as reasonably practicable. However, it's important to note that even if you opt out of receiving marketing-related emails from us, we retain the right to communicate with you about the Services you receive (like support and important legal notices) and our Business Users might still send you messages or instruct us to send you messages on their behalf.
...
-   The right to request access to the Personal Data Stripe processes about you ([Learn More](https://stripe.com/en-br/legal/privacy-center#how-do-i-access-my-data));
...
In cases where we keep your Personal Data, we do so in accordance with any limitation periods and record retention obligations imposed by applicable law. [Learn More](https://stripe.com/en-br/legal/privacy-center#how-long-will-stripe-keep-my-data).

## 6\. International Data Transfers

As a global business, it's sometimes necessary for us to transfer your Personal Data to countries other than your own, including the United States. These countries might have data protection regulations that are different from those in your country. When transferring data across borders, we take measures to comply with applicable data protection laws related to such transfer. In certain situations, we may be required to disclose Personal Data in response to lawful requests from officials, such as law enforcement or security authorities. [Learn More](https://stripe.com/en-br/legal/privacy-center#how-is-stripe-dealing-with-international-data-transfers).

If you are located in the European Economic Area (“EEA”), the United Kingdom ("UK"), or Switzerland, please refer to our [Privacy Center](https://stripe.com/en-br/legal/privacy-center) for additional details. When a data transfer mechanism is mandated by applicable law, we employ one or more of the following:
...
-   **India**. In this Policy, “applicable law” includes the Digital Personal Data Protection Act (“DPDPA”) once the DPDPA enters into effect. Further, the term “data controller” includes “data fiduciaries,” and the term “data subject” includes “data principal,” both as defined in the DPDPA.
    ...
    -   If you have any questions or complaints regarding the processing of your Personal Data in India, or if you want to receive this Policy or communicate with us about privacy in one of India’s official languages, please [contact our Nodal and Grievance Officer](mailto:complaints-in@stripe.com). [Learn More](https://stripe.com/en-br/legal/privacy-center#where-can-i-lodge-my-complaint-on-data-handling-in-india). Alternatively, you may contact our DPO at dpo@stripe.com. If we are unable to address your complaint or grievance, you have the right to escalate the matter to the Data Protection Board of India.
...
-   **Switzerland**. In this Policy, “applicable law” includes the Swiss Federal Act on Data Protection (“FADP”), as revised. To exercise your rights under the FADP, please contact our DPO at dpo@stripe.com. You may also have additional rights under the Swiss-U.S. Data Privacy Framework. [Learn More](https://stripe.com/en-ie/legal/data-privacy-framework).
...
-   **United States**. If you are a consumer located in the United States (“US”), we process your personal information in accordance with US federal and state privacy laws. For additional  details, please review the information below and see our additional U.S. Privacy Disclosures [here](https://stripe.com/en-br/legal/privacy-center#categories-of-personal-information-collected-and-disclosed-under-the-ccpa:~:text=period%20of%20time.-,U.S.%20Privacy%20Disclosures,-Categories%20of%20Personal). Stripe uses cookies, including advertising cookies, as described in our [Cookie Policy](https://stripe.com/en-br/legal/cookies-policy).
    -   **Your Rights and Choices**. As a US consumer and subject to certain limitations under US privacy laws, you may have choices regarding our use and disclosure of your Personal Data.  In addition to the [above rights](https://stripe.com/en-br/privacy#4-your-rights-and-choices), you may also have the rights listed in this section. Please see our Privacy Center to [learn more](https://stripe.com/en-br/legal/privacy-center#california-privacy-rights-metrics) about data subject rights metrics and [learn more](https://stripe.com/en-br/legal/privacy-center#how-do-i-exercise-my-data-protection-rights) about the laws under which these rights may apply. 
    ...
    -   **Global Privacy Control signals**. Stripe honors the Global Privacy Control (GPC) opt-out preference signals. [Learn More](https://stripe.com/en-br/legal/privacy-center#contact-us).

## 9\. Contact us

If you have any questions or complaints about this Policy, please [contact us](https://stripe.com/en-br/legal/privacy-center#contact-us). If you are an End Customer (i.e., an individual doing business or transacting with a Business User), please refer to the privacy policy or notice of the Business User for information regarding the Business User’s privacy practices, choices and controls, or contact the Business User directly.
...
Contact us at [privacy@stripe.com](mailto:privacy@stripe.com) or visit us at [https://support.link.com](https://support.link.com/)
...
For additional information about our privacy practices, please visit the [Stripe Privacy Center](https://stripe.com/en-br/privacy-center/legal).

[Stripe logo](/en-br)

Brazil (English)

-   ![AU](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Australia
    -   [English](https://stripe.com/au/privacy)
-   ![AT](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Austria
    -   [Deutsch](https://stripe.com/at/privacy)
    -   [English](https://stripe.com/en-at/privacy)
-   ![BE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Belgium
...
-   ![BG](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Bulgaria
    -   [English](https://stripe.com/en-bg/privacy)
-   ![CA](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Canada
    -   [English](https://stripe.com/en-ca/privacy)
    -   [Français](https://stripe.com/fr-ca/privacy)
-   ![CN](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) China
    -   [简体中文](https://stripe.com/cn/privacy)
    -   [English](https://stripe.com/en-cn/privacy)
-   ![HR](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Croatia
    -   [English](https://stripe.com/en-hr/privacy)
    -   [Italiano](https://stripe.com/it-hr/privacy)
-   ![CY](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Cyprus
    -   [English](https://stripe.com/en-cy/privacy)
-   ![CZ](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Czech Republic
    -   [English](https://stripe.com/en-cz/privacy)
-   ![DK](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Denmark
    -   [English](https://stripe.com/en-dk/privacy)
-   ![EE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Estonia
    -   [English](https://stripe.com/en-ee/privacy)

-   ![FI](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Finland
    -   [English](https://stripe.com/en-fi/privacy)
    -   [Svenska](https://stripe.com/sv-fi/privacy)
-   ![FR](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) France
    -   [Français](https://stripe.com/fr/privacy)
    -   [English](https://stripe.com/en-fr/privacy)
-   ![DE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Germany
    -   [Deutsch](https://stripe.com/de/privacy)
    -   [English](https://stripe.com/en-de/privacy)
-   ![GI](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Gibraltar
    -   [English](https://stripe.com/en-gi/privacy)
-   ![GR](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Greece
    -   [English](https://stripe.com/en-gr/privacy)
-   ![HK](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Hong Kong
    -   [English](https://stripe.com/en-hk/privacy)
    -   [简体中文](https://stripe.com/zh-hk/privacy)
-   ![HU](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Hungary
    -   [English](https://stripe.com/en-hu/privacy)
-   ![IN](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) India
    -   [English](https://stripe.com/in/privacy)
-   ![IE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Ireland
    -   [English](https://stripe.com/ie/privacy)
-   ![IT](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Italy
    -   [Italiano](https://stripe.com/it/privacy)
    -   [English](https://stripe.com/en-it/privacy)
-   ![JP](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Japan
    -   [日本語](https://stripe.com/jp/privacy)
    -   [English](https://stripe.com/en-jp/privacy)
-   ![LV](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Latvia
    -   [English](https://stripe.com/en-lv/privacy)

-   ![LI](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Liechtenstein
    -   [Deutsch](https://stripe.com/de-li/privacy)
    -   [English](https://stripe.com/en-li/privacy)
-   ![LT](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Lithuania
    -   [English](https://stripe.com/en-lt/privacy)
-   ![LU](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Luxembourg
    -   [Français](https://stripe.com/fr-lu/privacy)
    -   [Deutsch](https://stripe.com/de-lu/privacy)
    -   [English](https://stripe.com/en-lu/privacy)
-   ![MY](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Malaysia
    -   [English](https://stripe.com/en-my/privacy)
    -   [简体中文](https://stripe.com/zh-my/privacy)
-   ![MT](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Malta
    -   [English](https://stripe.com/en-mt/privacy)
-   ![MX](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Mexico
    -   [Español](https://stripe.com/mx/privacy)
    -   [English](https://stripe.com/en-mx/privacy)
-   ![NL](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Netherlands
    -   [Nederlands](https://stripe.com/nl/privacy)
    -   [English](https://stripe.com/en-nl/privacy)
-   ![NZ](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) New Zealand
    -   [English](https://stripe.com/nz/privacy)
-   ![NO](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Norway
    -   [English](https://stripe.com/en-no/privacy)
-   ![PL](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Poland
    -   [English](https://stripe.com/en-pl/privacy)
-   ![PT](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Portugal
    -   [Português](https://stripe.com/pt-pt/privacy)
    -   [English](https://stripe.com/en-pt/privacy)
-   ![RO](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Romania
    -   [English](https://stripe.com/en-ro/privacy)

-   ![SG](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Singapore
    -   [English](https://stripe.com/en-sg/privacy)
    -   [简体中文](https://stripe.com/zh-sg/privacy)
-   ![SK](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Slovakia
    -   [English](https://stripe.com/en-sk/privacy)
-   ![SI](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Slovenia
    -   [English](https://stripe.com/en-si/privacy)
    -   [Italiano](https://stripe.com/it-si/privacy)
-   ![ES](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Spain
    -   [Español](https://stripe.com/es/privacy)
    -   [English](https://stripe.com/en-es/privacy)
-   ![SE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Sweden
    -   [Svenska](https://stripe.com/se/privacy)
    -   [English](https://stripe.com/en-se/privacy)
-   ![CH](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Switzerland
...
-   ![TH](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) Thailand
    -   [ไทย](https://stripe.com/th/privacy)
    -   [English](https://stripe.com/en-th/privacy)
-   ![AE](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) United Arab Emirates
    -   [English](https://stripe.com/ae/privacy)
-   ![GB](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) United Kingdom
    -   [English](https://stripe.com/gb/privacy)
-   ![US](https://images.stripeassets.com/fzn2n1nzq965/6NuF1mvaIeEQbkEzqr5ri7/b4adfbc07d16fa159404eca23c2ab99a/flags.svg) United States
...
-   [Pricing](https://stripe.com/en-br/pricing)
-   [Atlas](/en-br/atlas)
-   [Authorization Boost](/en-br/authorization-boost)
-   [Billing](/en-br/billing)
-   [Capital](/en-br/capital/platforms)
-   [Checkout](/en-br/payments/checkout)
-   [Climate](/en-br/climate)
-   [Connect](/en-br/connect)
-   [Crypto](/en-br/use-cases/crypto)
-   [Data Pipeline](/en-br/data-pipeline)
-   [Elements](/en-br/payments/elements)
-   [Financial Connections](/en-br/financial-connections)
-   [Identity](/en-br/identity)
-   [Invoicing](/en-br/invoicing)
-   [Issuing](https://stripe.com/en-br/issuing)
-   [Link](/en-br/payments/link)
-   [Managed Payments](/en-br/managed-payments)
-   [Payment links](/en-br/payments/payment-links)
-   [Payments](/en-br/payments)
-   [Payouts](/en-br/connect/payouts)
-   [Radar](https://stripe.com/en-br/radar)
-   [Revenue Recognition](/en-br/revenue-recognition)
-   [Stripe Sigma](https://stripe.com/en-br/sigma)
-   [Tax](/en-br/tax)
-   [Terminal](/en-br/terminal)
-   [Treasury](/en-br/treasury)

# Solutions

-   [Enterprises](/en-br/enterprise)
-   [Startups](/en-br/startups)
-   [Agentic commerce](/en-br/use-cases/agentic-commerce)
-   [Crypto](/en-br/use-cases/crypto)
-   [Ecommerce](/en-br/use-cases/ecommerce)
-   [Embedded finance](/en-br/use-cases/embedded-finance)
-   [Finance automation](/en-br/use-cases/finance-automation)
-   [Global businesses](/en-br/use-cases/global-businesses)
-   [In-app payments](/en-br/use-cases/in-app-payments)
-   [Marketplaces](/en-br/use-cases/marketplaces)
-   [Platforms](/en-br/use-cases/platforms)
-   [SaaS](/en-br/use-cases/saas)
-   [AI companies](/en-br/use-cases/ai)
-   [Creator economy](/en-br/use-cases/creator-economy)
-   [Gaming](/en-br/industries/gaming)
-   [Hospitality, travel, and leisure](/en-br/industries/travel)
-   [Insurance](/en-br/industries/insurance)
-   [Media and entertainment](/en-br/industries/media-entertainment)
-   [Nonprofits](/en-br/industries/nonprofits)
-   [Professional services](/en-br/industries/professional-services)
-   [Public sector](/en-br/industries/public-sector)
-   [Retail](/en-br/industries/retail)

# Integrations & custom solutions

-   [Stripe App Marketplace](https://marketplace.stripe.com/)
-   [Stripe Partner ecosystem](/en-br/partners)
-   [Professional services](/en-br/professional-services)
...
-   [Guides](https://stripe.com/en-br/guides)
-   [Customer stories](/en-br/customers)
-   [Blog](/blog)
-   [Community](https://stripecommunity.com/)
-   [Sessions annual conference](/en-br/sessions)
-   [Privacy & terms](https://stripe.com/en-br/privacy)
-   [Prohibited & restricted businesses](/en-br/legal/restricted-businesses)
-   [Licenses](https://stripe.com/en-br/spc/licenses)
-   [Sitemap](/en-br/sitemap)
-   [Cookie settings](/en-br/cookie-settings)
-   [More resources](https://stripe.com/en-br/resources/more)

# Company

-   [Institutional](/en-br/institutional)
-   [Product roadmap](/roadmap)
-   [Jobs](/en-br/jobs)
-   [Newsroom](/en-br/newsroom)
-   [Stripe Press](https://press.stripe.com/)
-   [Contact sales](/en-br/contact/sales)

# Support

-   [Get support](https://support.stripe.com/?referrerLocale=en-br)
-   [Managed support plans](/en-br/support-plans)
